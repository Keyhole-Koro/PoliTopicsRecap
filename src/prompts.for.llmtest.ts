...
- dialogs の summary / summary_sections / qa は内容を重複させない。qa がある場合、質問・回答の内容は summary / summary_sections に書かない。summary_sections を使う場合、summary はセクションに含めない別の要点のみを短く入れる。
